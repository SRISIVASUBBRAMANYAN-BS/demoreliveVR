class RelieVRApp {
  constructor() {
    this.currentStep = 0 // Start from step 0 for patient info
    this.totalSteps = 5 // Updated to 5 steps including patient info
    this.patientInfo = {} // Added patient info storage
  ...
  handlePostAssessmentSubmit() {
    ...
    // Check if all 10 post-assessment questions are answered
  ...
  completeVRSession() {
    ...
    setTimeout(() => {
      this.exitVRSession()
      this.nextStep() // This will move to post-assessment step
    }, 3000)
  }
